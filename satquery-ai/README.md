...
[![Tests Passing](https://img.shields.io/badge/tests-62%2F62%20passed-brightgreen.svg)](tests/)
...
```
[Input T1, T2] ──▶ [Co-registration] ──▶ [Radiometric Normalization] ──▶ [Index Selection]
                         │
                         ▼
[Confidence Scoring] ◀── [Region Stats] ◀── [Morphology Clean] ◀── [Otsu Threshold]
         │                                                            ▲
         ▼                                                            │
  [Final GeoJSON & NL Report] ◀── [STSF-Net Pseudo-Filter] ◀── [Diff Map Computation]
```
...
Simply open `PROJECT/frontend/index.html` in any modern web browser:
```bash
# Windows
...
│   │   │   ├── risat.py                # RISAT-1C SAR backscatter calibration ($\sigma^0$)
...
|:---|:---|:---|
| **Lead Architect** | Team Lead & AI/ML Engineer | Vision-Language Models, GeoChat-7B integration, query routing |
| **CV / Remote Sensing Lead** | Computer Vision Specialist | 12-stage change detection pipeline, STSF-Net pseudo-change suppression |
| **Backend Engineer** | Systems & Cloud Architect | FastAPI backend, Docker containerization, asynchronous processing |
| **Frontend Engineer** | UI/UX Developer | Mission control single-page application, Leaflet GeoJSON visualization |
| **Geospatial Data Specialist** | ISRO Domain Expert | Satellite sensor calibration (Cartosat, RISAT, ResourceSat), spectral indices |
| **Presenter & Pitch Lead** | Product Strategist & Spokesperson | 10-minute pitch delivery, slide deck, live demo coordination |
